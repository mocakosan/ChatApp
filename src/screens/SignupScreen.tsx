        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.section}>
            ...
            <TextInput
              ...
              style={styles.input}
              secureTextEntry
              onChangeText={onChangePasswordText}></TextInput>
            {emailErrorText && (
          ...
          <View style={styles.section}>
            ...
            <TextInput
              ...
              secureTextEntry
              style={styles.input}
              onChangeText={onChangeConfirmedPasswordText}></TextInput>
            {emailErrorText && (
          ...
          <View style={styles.section}>
            ...
            <TextInput
              value={name}
              style={styles.input}
              onChangeText={onChangeNameText}></TextInput>
            {nameErrorText && (
          ...
          <View>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.siginButtonText}>
                이미 계정이 있으신가요?
              </Text>
            </TouchableOpacity>
          </View>
